...
from vllm.executor.mpi_worker_utils import (
...
class MPIGPUExecutor(DistributedGPUExecutor):
    ...
    def _init_executor(self) -> None:
        ...
        logger.info("Creating driver worker")
...
class MPIGPUExecutorAsync(MPIGPUExecutor,
